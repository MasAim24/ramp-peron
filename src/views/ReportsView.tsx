...
export const ReportsView: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3.5 flex flex-wrap items-center justify-between gap-3 text-xs shadow-2xs transition-colors">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <select
            ...
            className="px-2.5 py-1.5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-700 rounded-lg text-zinc-900 dark:text-zinc-200 focus:outline-none focus:border-emerald-500"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-lg bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 border border-zinc-300 dark:border-zinc-700 font-semibold text-xs flex items-center gap-1.5 transition-colors cursor-pointer shadow-2xs"
          >
            ...
            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800/60 font-sans">
              {filtered.map(rec => (
                <tr key={rec.id} className="hover:bg-zinc-50/80 dark:hover:bg-zinc-850/50 transition-colors">
                  ...
                  <td className="py-2.5 px-3 text-zinc-500 dark:text-zinc-400 whitespace-nowrap text-[11px]">
