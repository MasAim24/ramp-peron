...
export const PriceBoardView: React.FC = () => {
  ...
  const [simulationTon, setSimulationTon] = useState<number>(85);
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden shadow-2xs transition-colors">
            ...
            <form onSubmit={handleSavePrice} className="p-5 space-y-4 text-xs">
              <div className="p-3 bg-zinc-50 dark:bg-zinc-950 rounded-lg border border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
                <div>
                  <span className="text-zinc-600 dark:text-zinc-500 text-[11px] block font-medium">Acuan Harga Jual Peron ke PKS:</span>
                  <span className="text-xs text-zinc-500 dark:text-zinc-400">Harga tertinggi kontrak PKS mitra aktif</span>
                </div>
                <div className="w-44">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-full px-2.5 py-1.5 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-lg text-emerald-700 dark:text-emerald-400 font-mono text-sm font-bold text-right focus:outline-none focus:border-emerald-500"
                    />
                    <span className="text-zinc-500 dark:text-zinc-400 font-mono">/Kg</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-2">
                <h3 className="font-bold text-zinc-800 dark:text-zinc-200 text-xs uppercase tracking-wider">
                  Harga Beli Peron dari Petani / Supplier (Rp/Kg):
                </h3>

                {/* Grade Super */}
                <div className="p-3.5 bg-zinc-50 dark:bg-zinc-950/70 border border-zinc-200 dark:border-zinc-800 rounded-lg flex items-center justify-between gap-4">
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 text-xs block">GRADE SUPER (Usia Tanam &gt; 10 Tahun)</strong>
                ...
                {/* Grade A */}
                <div className="p-3.5 bg-zinc-50 dark:bg-zinc-950/70 border border-emerald-300 dark:border-emerald-900/40 rounded-lg flex items-center justify-between gap-4">
                  <div>
                    <strong className="text-emerald-700 dark:text-emerald-400 text-xs block">GRADE A (Usia Tanam 5 - 10 Tahun) &bull; Standar Utama</strong>
                  ...
                  <div className="w-40 flex items-center gap-2">
                    <input
                      ...
                      className="w-full px-2.5 py-1.5 bg-white dark:bg-zinc-900 border border-emerald-400 dark:border-emerald-700 rounded-lg text-emerald-700 dark:text-emerald-400 font-mono text-sm font-bold text-right focus:outline-none focus:border-emerald-500"
                    />
                    <span className="text-zinc-500 dark:text-zinc-400 font-mono">/Kg</span>
                  </div>
                </div>
                ...
                <div className="p-3.5 bg-zinc-50 dark:bg-zinc-950/70 border border-zinc-200 dark:border-zinc-800 rounded-lg flex items-center justify-between gap-4">
                  <div>
                    <strong className="text-zinc-900 dark:text-zinc-100 text-xs block">GRADE B (Buah Pasir / Usia 3 - 5 Tahun)</strong>
                  ...
                  <div className="w-40 flex items-center gap-2">
                    <input
                      ...
                      className="w-full px-2.5 py-1.5 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-lg text-zinc-900 dark:text-zinc-100 font-mono text-sm font-bold text-right focus:outline-none focus:border-emerald-500"
                    />
                    <span className="text-zinc-500 dark:text-zinc-400 font-mono">/Kg</span>
                  </div>
                </div>
              ...
              <div className="p-3 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg flex items-center justify-between text-xs">
                <div>
                  <span className="text-zinc-700 dark:text-zinc-400 font-medium">Target Spread Margin Kotor Peron:</span>
                  <p className="text-[11px] text-zinc-500">Selisih antara jual ke PKS vs beli Grade A</p>
                </div>
                <div className="text-right">
                  <span className="text-emerald-700 dark:text-emerald-400 font-black font-mono text-base">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-zinc-50 dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-800 rounded-lg text-zinc-900 dark:text-zinc-200 focus:outline-none focus:border-emerald-500"
                />
              </div>
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 text-xs space-y-3 shadow-2xs transition-colors">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="text-zinc-600 dark:text-zinc-400 font-medium">Target Tonase Harian Peron:</label>
                <span className="font-mono font-bold text-emerald-700 dark:text-emerald-400 text-sm">{simulationTon} TON ({formatKg(simulationTon * 1000)})</span>
              </div>
              <input
                type="range"
                min="10"
            ...
            <div className="p-3 bg-zinc-50 dark:bg-zinc-950 rounded-lg border border-zinc-200 dark:border-zinc-800 space-y-1.5">
              ...
              <div className="flex justify-between font-bold text-emerald-700 dark:text-emerald-400 text-sm border-t border-zinc-200 dark:border-zinc-800 pt-1.5">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 text-xs space-y-3 shadow-2xs transition-colors">
            <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-2">
              ...
              <button
                ...
                className="px-2.5 py-1 rounded bg-emerald-50 dark:bg-emerald-600/20 hover:bg-emerald-100 dark:hover:bg-emerald-600/30 text-emerald-700 dark:text-emerald-400 border border-emerald-300 dark:border-emerald-500/40 font-semibold flex items-center gap-1 transition-colors cursor-pointer text-[11px] shadow-2xs"
              >
            ...
            <div className="p-3 bg-zinc-50 dark:bg-zinc-950 rounded-lg border border-zinc-200 dark:border-zinc-800 font-mono text-[11px] text-zinc-800 dark:text-zinc-300 whitespace-pre-wrap max-h-48 overflow-y-auto leading-relaxed select-all">
              {waBroadcastText}
            </div>
          </div>
        </div>
